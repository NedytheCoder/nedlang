...
const LOADING_MESSAGE_KEYS = [
  "assess_listen_loading_1",
  "assess_listen_loading_2",
  "assess_listen_loading_3",
  "assess_listen_loading_4",
]
...
export default function ListeningPage() {
  ...
  const questionsRef = useRef<ListeningQuestion[]>([])
  const responsesRef = useRef<AssessmentResponse[]>([])
  ...
  useEffect(() => {
    ...
    fetch(`${BACKEND_URL}/user/profile/${userId}`)
      ...
      .then((profile) => {
        ...
        return fetch(`${BACKEND_URL}/reception/test/listening_questions`, {
          method: "POST",
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="relative z-10 max-w-xl mx-auto px-4 sm:px-6 py-8">
        ...
        >
          ...
          <div className="px-5 sm:px-8 py-6 min-h-[420px]">
          ...
          {!isDone && (
            <div className="px-5 sm:px-8 pb-6 pt-2 border-t border-slate-100 dark:border-white/6">
              ...
              >
                {isFinal ? t("assess_continue_writing") : t("assess_submit")}
              </motion.button>
            </div>
          )}
        </motion.div>
