...
export default function VocabularyAnalytics({ vocab }: Props) {
  const { t } = useTranslation()

  const stats = [
    { value: vocab.total.toLocaleString(), labelKey: "dash_vocab_total", color: "text-indigo-600 dark:text-indigo-400" },
    { value: vocab.active.toLocaleString(), labelKey: "dash_vocab_active", color: "text-emerald-600 dark:text-emerald-400" },
    { value: `${vocab.retentionRate}%`, labelKey: "dash_vocab_retention", color: "text-violet-600 dark:text-violet-400" },
    { value: `+${vocab.newPerWeek}`, labelKey: "dash_vocab_per_week", color: "text-blue-600 dark:text-blue-400" },
  ]
